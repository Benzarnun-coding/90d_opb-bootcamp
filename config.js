...
window.CFG = {
  ...
  SPRINTS: [
    { n:"FIND YOUR VOICE", th:"หาแนวของตัวเอง ลองให้ครบทุกฟอร์แมต", e:"🎤" },
    { n:"HOOK MASTER",     th:"3 วินาทีแรกต้องหยุดนิ้วคนดูให้ได้",  e:"🪝" },
    { n:"STORY ENGINE",    th:"เล่าเรื่องให้คนดูอยู่จนจบคลิป",       e:"📖" },
    { n:"SERIES BUILDER",  th:"ทำคอนเทนต์เป็นซีรีส์ให้คนรอตอนต่อ",  e:"📚" },
    { n:"GROWTH PUSH",     th:"ยิงให้ถึงคนใหม่ที่ยังไม่รู้จักเรา",    e:"🚀" },
    { n:"SIGNATURE",       th:"สร้างลายเซ็นที่คนเห็นแล้วรู้ว่าเรา",   e:"👑" }
  ],
